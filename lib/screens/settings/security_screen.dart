      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setState) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              const Text(
                'This action is irreversible. All your data will be permanently lost. Please enter your password to confirm.',
              ),
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text('Change Password', style: Theme.of(context).textTheme.titleLarge?.bold),
            ...
            const Divider(),
            const SizedBox(height: 24),
            Text('Danger Zone', style: Theme.of(context).textTheme.titleMedium?.bold.copyWith(color: Theme.of(context).colorScheme.error)),
            const SizedBox(height: 16),
            ListTile(
